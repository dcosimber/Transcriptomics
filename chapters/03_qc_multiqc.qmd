...
Este capítulo documenta los módulos principales generados por **[`nf-core/rnaseq`](https://nf-co.re/rnaseq)** en la rama `star_salmon`, ejecutada sobre **[Nextflow](https://www.nextflow.io/)** [@Ewels2020Nfcore; @DiTommaso2017Nextflow]: **fastp**, **STAR**, **Samtools**, **Picard**, **strand check** y **versiones de software**. La interpretación combina dos niveles: una lectura *técnica*, centrada en si las bibliotecas son válidas para el análisis downstream, y una lectura *biológica*, centrada en si los resultados permiten confiar en la señal transcriptómica posterior.
